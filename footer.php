...
<div id="success_submit" style="padding-bottom:60px;"></div>
                ...
                <div class="col text-center text-lg-start d-flex flex-column item" data-aos="fade-left" data-aos-once="true">
                    ...
                    <ul class="list-inline text-center mb-0">
                        ...
                        <li class="list-inline-item"><a href="https://yellowpages.com.eg/ar/search/Tooth-Yard-Dental-Clinic-_-Dr-Noha-Sidky" target="_blank"><img src="assets/img/Yellow-Logo.png?h=1a51500641fceb6c97881698878daef3" style="width: 50px;"></a></li>
                    </ul>
                </div>
            </div>
        </div>
