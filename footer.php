    ...
    <footer class="text-white bg-dark" style="background: linear-gradient(90deg, var(--green-dark), var(--green-main));">
        <div class="container py-4 py-lg-5">
            <div class="row row-cols-1 row-cols-md-3 justify-content-center">
                <div class="col text-center d-flex flex-column item" data-aos="fade-right" data-aos-once="true"><img class="img-fluid" src="assets/img/white.png">
                    ...
                    <form class="text-end float-none mx-auto rtl footer-form" id="contact-form" method="post"><input class="form-control" type="hidden" name="lang" value="arabic">
                        ...
                        <div class="controls">
                            <div class="row row-cols-1 rtl">
                                <div class="col">
                                    <div class="form-group"><label class="form-label m-0" for="formRequesterFirstName">الاسم :</label><input class="form-control" type="text" id="form_name" name="formRequesterFirstName" required="">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col py-0">
                                    <div class="form-group"><label class="form-label m-0" for="formRequesterEmail">البريد الالكتروني :</label><input class="form-control" type="email" id="form_email" name="formRequesterEmail" required="">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group"><label class="form-label m-0" for="formRequesterMobile">التليفون :</label><input class="form-control" type="tel" id="form_phone" name="formRequesterMobile" required="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group"><label class="form-label m-0" for="formRequesterMessage">الرسالة :</label><textarea class="form-control" id="form_message" name="formRequesterMessage" style="color: #333;"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12 text-center text-md-start pt-3"><button class="btn btn-dark btn-lg text-center float-none" id="submit-button" value="راسلنا" type="submit" required="" name="submit" style="width: 100%;background-color: var(--green-dark);font-family: inherit;">راسلنا&nbsp;<br></button></div>
                        </div>
                    </form>
<script>
...
<div id="success_submit" style="padding-bottom:60px;"></div>
                ...
                <div class="col text-center text-lg-start d-flex flex-column item" data-aos="fade-left" data-aos-once="true">
                    <p class="text-center rtl">العنوان<br>53 شارع شهاب المهندسين<br>الدور الثاني – جيزة -&nbsp;مصر<br><br><a href="tel:01066771440"><span style="color: rgb(255, 255, 255);">01066771440</span></a><br><a href="mailto:toothyard@gmail.com"><span style="color: rgb(255, 255, 255);">toothyard@gmail.com</span></a><br></p>
                    ...
                    <ul class="list-inline text-center mb-0">
                        ...
                        <li class="list-inline-item"><a href="https://yellowpages.com.eg/ar/search/Tooth-Yard-Dental-Clinic-_-Dr-Noha-Sidky" target="_blank"><img src="assets/img/Yellow-Logo.png" style="width: 50px;"></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 py-2">
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-center align-items-center justify-content-md-end pt-3">
                            <p class="mb-0">Built and Managed by<br></p><img src="assets/img/YELLOW-BLACK.png">
                        </div>
                    </div>
                </div>
            </div>
        </section><a href="https://web.whatsapp.com/send?phone=201066771440&amp;text" style="position: fixed;right: 60px;bottom: 60px;z-index: 200;" target="_blank"><img class="img-fluid" src="assets/img/social-whatsapp-circle-512.webp"></a>
    </footer>
