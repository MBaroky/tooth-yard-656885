<?php include 'header.php'; ?>
                    ...
                    <div class="simple-slider">
                        <div class="swiper">
                            <div class="swiper-wrapper" style="height: auto;">
                                <div class="swiper-slide" style="background: url(&quot;assets/img/home-slider-1.png&quot;) left / cover no-repeat;"></div>
                                <div class="swiper-slide" style="background: url(&quot;assets/img/home-slider-2.png&quot;) left / cover no-repeat;"></div>
                            </div>
    ...
    <section id="about" class="bg-primary" style="background: url(&quot;assets/img/home-bg-1.jpg&quot;) center / cover no-repeat;padding-bottom: 0;height: 600px;">
        ...
        <div class="container py-5 px-md-5" style="background: #E2F7EB;max-width: 800px;">
            <div class="row">
                <div class="col offset-lg-8 text-center mx-auto" data-aos="fade-left" data-aos-duration="700" data-aos-once="true">
                    ...
                    <div class="row">
                        <div class="col"><img data-aos="zoom-in" data-aos-once="true" class="mx-2" src="assets/img/Cib_Logo_svg.png" style="width: 130px;"><img data-aos="zoom-in" data-aos-once="true" class="mx-2" src="assets/img/unnamed2.png" style="width: 70px;"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="photo-gallery py-5 bg-main">
        <div class="container">
            <div class="row gx-2 gy-2 row-cols-2 row-cols-md-3 row-cols-lg-5 photos" data-bss-baguettebox="">
                <div class="col item"><a href="assets/img/fullsize/home-1.webp"><img class="img-fluid" src="assets/img/thumbnails/thumb-1.jpeg"></a></div>
                <div class="col item"><a href="assets/img/fullsize/home-2.webp"><img class="img-fluid" src="assets/img/thumbnails/thumb-2.jpeg"></a></div>
                <div class="col item"><a href="assets/img/fullsize/home-3.webp"><img class="img-fluid" src="assets/img/thumbnails/thumb-3.jpeg"></a></div>
                <div class="col item"><a href="assets/img/fullsize/home-4.webp"><img class="img-fluid" src="assets/img/thumbnails/thumb-4.jpeg"></a></div>
                <div class="col item"><a href="assets/img/fullsize/home-5.webp"><img class="img-fluid" src="assets/img/thumbnails/thumb-5.jpeg"></a></div>
            </div>
        </div>
    </section>
    <!--end of content-->
