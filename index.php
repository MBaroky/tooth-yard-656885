...
<?php include 'header.php'; ?>
    <header class="masthead" style="height: auto;padding: 0;min-height: 0 !important;">
        <div class="container-fluid my-auto" style="padding: 0;">
            <div class="row g-0 row-cols-1 row-cols-md-2">
                <div class="col text-center pb-4" data-aos="fade-right" data-aos-once="true" style="padding-top: 118px;">
                    <h1 class="text-center heading-font color-dark m-0 lh-1" style="letter-spacing: 2px;font-weight: 400;font-size: 70px;">عيادة</h1>
                    <h1 class="text-center heading-font color-main m-0 lh-1" id="cover-company-name" style="font-size: 136px;font-weight: 900;font-family: Jenine;">توث يارد<br></h1>
                    <h1 class="text-center heading-font color-dark m-0 lh-1" id="cover-doctor-name" style="font-size: 69px;font-weight: 700;">د. نهى صدقى<br></h1>
                    <h1 class="text-center heading-font color-main m-0 lh-1" id="cover-slogan" style="font-size: 55px;font-weight: 100;">أستعيد بسمتك<br></h1><a class="btn btn-primary btn-lg text-center px-5 mt-3 bg-main" role="button" style="margin-right: auto;margin-left: auto;display: inline-block;font-family: Almarai, sans-serif;">احجز الان</a>
                </div>
        ...
        <div class="container-fluid">
            <div class="row g-0 row-cols-1">
                <div class="col text-center d-flex float-end justify-content-end" data-aos="fade-left" data-aos-duration="700" data-aos-once="true">
                    <div class="text-center d-flex justify-content-center" style="width: 980px;max-width: 100%;">
                        <div class="py-5 px-md-5" style="background: #E2F7EB;max-width: 800px;">
                            <h2 class="section-heading rtl color-main mt-3" style="font-family: Jenine;font-size: 60px;">عن العيادة :<br></h2>
                            ...
                            <p class="color-dark">متاح التقسيط بدون فوائد عن طريق<br></p>
                            <div class="row mb-5">
                                <div class="col"><img data-aos="zoom-in" data-aos-once="true" class="mx-2" src="assets/img/Cib_Logo_svg.png?h=c1144a92f58ea18493f5989a10b33024" style="width: 180px;"><img data-aos="zoom-in" data-aos-once="true" class="mx-2" src="assets/img/unnamed2.png?h=30ccc02f251207e9ac5dde8ea5df4b28" style="width: 90px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="photo-gallery py-5" style="background-color: #BADA55;">
        <div class="container">
